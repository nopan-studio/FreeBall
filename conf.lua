...
function love.conf(t)
    ...
    t.identity = "fatespalms.FreeBall"  -- The name of the save directory (string)
    ...
    t.window.title = "Free Ball"       -- The window title (string)
    t.window.icon = "assets/logo.png"   -- Filepath to an image to use as the window's icon (string)
